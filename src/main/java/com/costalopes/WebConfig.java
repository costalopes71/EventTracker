...
public class WebConfig extends WebMvcConfigurerAdapter {
	...
	// Internacionalizacao: os dois beans abaixo sao autowired por nome! ou seja a assinatura tem que ter exatamente esses nomes
	
	// carregando o arquivo properties que contem as mensagens
	@Bean
	...
	// tentando obter o locale da sessao e setando o locale default
	@Bean
	...
	// adicionando um interceptor que ira interceptar o request caso haja uma mudanca no atributo language
	@Override
